...
class ReponseController extends AbstractController
{
    ...
    public function new(Request $request, ReponseRepository $reponseRepository,Reclamation $reclamation): Response
    {
        ...
        {
            $sid = "AC7ca5f9b50edfc3d5663edd3d94f53220"; // Your Account SID from www.twilio.com/console
            $token = "97881a927d14b199ecc3ec47f9eff963"; // Your Auth Token from www.twilio.com/console

            $client = new Client($sid, $token);
            $message = $client->messages->create(
                '+21626843894', // Text this number
                [
                    'from' => '+12762862015', // From a valid Twilio number
                    'body' => $description
                ]
            );
