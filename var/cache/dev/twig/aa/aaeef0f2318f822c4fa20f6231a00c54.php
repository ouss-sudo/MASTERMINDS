...
class __TwigTemplate_1b9d28ab371b2423dada8ec5697bf26b extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  55 => 4,  51 => 3,  46 => 2,  43 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("{{ form_start(form,{'attr': {'novalidate': 'novalidate'}}) }} {# est une option que l'on peut ajouter à une balise HTML <form> pour désactiver la validation automatique HTML5 #}
    {{ form_widget(form) }}
<button class=\"btn\">{{ button_label|default('Envoyer') }}</button>
{{ form_end(form) }}
", "reclamation/_form.html.twig", "C:\\Users\\miral\\OneDrive\\Bureau\\FirstProjecttt\\templates\\reclamation\\_form.html.twig");
    }
}
