...
class __TwigTemplate_919f7972ad40eb1cff82ca85585c28fd extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "\" onsubmit=\"return confirm('Voulez vous vraiment supprimer cette réclamation?');\">
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_reclamation_delete', {'id': reclamation.id}) }}\" onsubmit=\"return confirm('Voulez vous vraiment supprimer cette réclamation?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ reclamation.id) }}\">
    <button class=\"btn\"><img src=\"{{ asset('assets/img/delete.png') }}\" height=\"30\" width=\"30\"></button>
</form>
", "reclamation/_delete_form.html.twig", "C:\\Users\\miral\\OneDrive\\Bureau\\FirstProjecttt\\templates\\reclamation\\_delete_form.html.twig");
    }
}
