...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\ManyToMany(targetEntity: Reclamation::class, mappedBy: 'users')]
    private Collection $reclamations;

    #[ORM\OneToMany(mappedBy: 'user', targetEntity: Constat::class)]
...
*/
   ...
   public function removeConstat(Constat $constat): self
   {
       if ($this->constats->removeElement($constat)) {
           ...
           if ($constat->getUser() === $this) {
               $constat->setUser(null);
           }
       }
